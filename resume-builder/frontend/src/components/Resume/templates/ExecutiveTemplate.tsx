...
export function ExecutiveTemplate({ resume }: TemplateProps) {
  ...
  const linkColor = "#000"; // Executive style often minimal on colors
  ...
  return (
    ...
    >
      ...
      {/* Education - Executive often places education later, but we stick to schema order unless customized */}
